...
def main():
    ...
    data = data_loader.Dataset(args, args.path, train_list, test_list, data_type = 'train')
    data_valid = data_loader.Dataset(args, args.path, None, test_list, data_type = 'valid')
    data_test = data_loader.Dataset(args, args.path, train_list, test_list, data_type = 'test')
