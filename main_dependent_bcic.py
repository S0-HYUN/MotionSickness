...
def main():
    ...
    # Load data
    data = data_loader.data_loader_bcic.Dataset(args, phase="train")
    data_valid = data_loader.data_loader_bcic.Dataset(args, phase="valid")
    data_test = data_loader.data_loader_bcic.Dataset(args, phase="test")
