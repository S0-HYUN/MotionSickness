...
add function
'''
def dcca_eeg(pretrained='EEGNet'):
    model = DCCANet(DCCAResNetBottleneck, [3, 4, 6, 3], groups=1, reduction=16,
                    dropout_p=None, inplanes=64, input_3x3=False,
                    downsample_kernel_size=1, downsample_padding=0)

    # pretrained_dict = attention_eegnet(num_classes=1000, pretrained=pretrained).state_dict()
...
add function
'''
def attention_eegnet(num_classes=1000, pretrained='EEGNet'):
